        ...
        <div className="flex flex-col gap-4 rounded-lg w-full bg-amber-50/20 backdrop-blur-lg p-4 pt-1 overflow-y-hidden md:w-[60dvw] lg:w-[40dvw]">
            ...
            <span className="flex gap-2 justify-between items-center w-full pb-1 border-b-2 border-slate-300/30">
                ...
                <ClientButton 
                    ...
                    className='flex gap-1 items-center text-sm transition-colors hover:bg-amber-50/20 cursor-pointer rounded px-1 focus:outline-none focus:bg-amber-50/20 ml-auto'
                >
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="size-5">
                ...
                {/* <ClientButton 
                    render={(props) =>
                        ...
                        />
                        <MemberList members={group_members} {...props}/>
                        </>
                    }
                    className='flex gap-2 items-center text-sm transition-colors hover:bg-amber-50/20 cursor-pointer rounded px-1 focus:outline-none focus:bg-amber-50/20'
                >
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="size-5">
